---
description: Standalone verify — checks git-modified changes only, shows summary, Opus 5.5 medium
---

Use the **orc-verify** skill independently (no orchestrator): verify
only the git-modified changes in the working tree using Opus 5.5 medium effort,
