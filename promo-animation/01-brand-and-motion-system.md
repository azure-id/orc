# ORC — brand & motion system (paste this FIRST, every time)

You are designing a set of short promotional animations for **ORC**, an
orchestrator skill constellation for Claude Code. This file is the shared design
system. Hold it for the whole conversation. The next message will give you one
scene to build.
...
Acknowledge that you have this system, then wait for the scene.
