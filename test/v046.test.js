...
const { cli, rmrf, freshInstall, REPO } = require("./_helpers");
...
test("panel: i18n never translates a CLI identifier", () => {
  const id = require(path.join(REPO, "bin", "webui", "i18n", "id.json"));
  const en = require(path.join(REPO, "bin", "webui", "i18n", "en.json"));
